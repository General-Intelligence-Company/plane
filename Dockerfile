...
ENV DEBUG=0
ENV ENABLE_SIGNUP=1
ENV ENABLE_EMAIL_PASSWORD=1
ENV ENABLE_MAGIC_LINK_LOGIN=0
...
COPY docker-entrypoint-beat-render.sh ./bin/docker-entrypoint-beat-render.sh
...
CMD ["./bin/docker-entrypoint-beat-render.sh"]
