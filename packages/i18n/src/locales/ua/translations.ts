...
export default {
  ...
  auth: {
    ...
    sign_up: {
      header: {
        label:
          "Створіть обліковий запис і почніть керувати роботою зі своєю командою.",
        step: {
          email: {
            header: "Реєстрація",
            sub_header: "",
          ...
          password: {
            header: "Реєстрація",
            sub_header:
              "Зареєструйтеся, використовуючи комбінацію електронної пошти та пароля.",
          },
          unique_code: {
            header: "Реєстрація",
            sub_header:
      ...
      header: {
        ...
        step: {
          ...
          password: {
            header: "Увійти або зареєструватися",
            sub_header:
              "Використовуйте комбінацію електронної пошти та пароля, щоб увійти.",
          },
          unique_code: {
            header: "Увійти або зареєструватися",
            sub_header:
              "Увійдіть за допомогою унікального коду, надісланого на вказану вище адресу електронної пошти.",
          },
        },
      },
    },
    forgot_password: {
      ...
      email_sent:
        "Ми надіслали посилання для відновлення на вашу електронну пошту",
      send_reset_link: "Надіслати посилання для відновлення",
      errors: {
        smtp_not_enabled:
          "Адміністратор не активував SMTP, тому неможливо надіслати посилання для відновлення пароля",
      },
      toast: {
        success: {
  ...
  select_or_customize_your_interface_color_scheme:
    "Виберіть або налаштуйте кольорову схему інтерфейсу.",
  ...
  settings_moved_to_preferences:
    "Налаштування часу та мови перенесено до параметрів.",
  ...
  enter_a_valid_hex_code_of_6_characters:
    "Введіть дійсний hex-код довжиною 6 символів",
  ...
  sidebar_background_color_is_required:
    "Колір фону бічної панелі є обов’язковим",
  ...
  email_notification_setting_updated_successfully:
    "Налаштування сповіщень електронною поштою успішно оновлено",
  failed_to_update_email_notification_setting:
    "Не вдалося оновити налаштування сповіщень електронною поштою",
  ...
  state_change_description:
    "Повідомляти, коли робоча одиниця переходить в інший стан",
  issue_completed: "Робоча одиниця завершена",
  issue_completed_description: "Повідомляти лише коли робоча одиниця завершена",
  comments: "Коментарі",
  comments_description:
    "Повідомляти, коли хтось додає коментар до робочої одиниці",
  mentions: "Згадки",
  mentions_description:
    "Повідомляти лише коли хтось згадає мене у коментарі чи описі",
  ...
  get_snapshot_of_each_active_cycle:
    "Отримайте знімок кожного активного циклу.",
  ...
  compare_burndowns_description:
    "Контролюйте ефективність команд за допомогою огляду burndown-звітів кожного циклу.",
  quickly_see_make_or_break_issues:
    "Швидко визначайте критичні робочі одиниці.",
  ...
  zoom_into_cycles_that_need_attention:
    "Зосередьтеся на циклах, що потребують уваги.",
  ...
  failed_to_reorder_favorite:
    "Не вдалося змінити порядок елементів у вибраному",
  ...
  project_link_copied_to_clipboard:
    "Посилання на проєкт скопійовано до буфера обміну",
  ...
  project_id_tooltip_content:
    "Допомагає унікально ідентифікувати робочі одиниці в проєкті. Макс. 10 символів.",
  description_placeholder: "Опис",
  only_alphanumeric_non_latin_characters_allowed:
    "Дозволені лише алфанумеричні та нелатинські символи.",
  ...
  anyone_in_the_workspace_except_guests_can_join:
    "Будь-хто в робочому просторі, крім гостей, може приєднатися",
  creating: "Створення",
  ...
  couldnt_add_the_project_to_favorites:
    "Не вдалося додати проєкт у вибране. Спробуйте ще раз.",
  ...
  couldnt_remove_the_project_from_favorites:
    "Не вдалося вилучити проєкт із вибраного. Спробуйте ще раз.",
  ...
  join_the_project_to_rearrange:
    "Приєднайтеся до проєкту, щоб змінити впорядкування",
  ...
  projects_and_issues_description:
    "Увімкніть або вимкніть ці функції в проєкті.",
  cycles_description:
  ...
  views_description:
    "Зберігайте власні сортування, фільтри та варіанти відображення або діліться ними з командою.",
  pages_description:
    "Створюйте та редагуйте довільний вміст: нотатки, документи, що завгодно.",
  intake_description:
  ...
  time_tracking_description:
    "Фіксуйте час, витрачений на робочі одиниці та проєкти.",
  ...
  we_are_having_trouble_fetching_the_updates:
    "Виникли проблеми з отриманням оновлень.",
  ...
  you_can_see_here_if_someone_invites_you_to_a_workspace:
    "Тут з’являтимуться запрошення до робочого простору",
  ...
  editor_is_not_ready_to_discard_changes:
    "Редактор ще не готовий скасувати зміни",
  failed_to_move_issue_to_project:
    "Не вдалося перемістити робочу одиницю до проєкту",
  ...
  view_link_copied_to_clipboard:
    "Посилання на подання скопійовано до буфера обміну.",
  ...
  new_password_must_be_different_from_old_password:
    "Новий пароль повинен бути відмінним від старого пароля",
  edited: "Редагувано",
  bot: "Бот",
  ...
  home: {
    empty: {
      ...
      invite_team: {
        ...
        description:
          "Співпрацюйте з колегами у створенні, постачанні та керуванні.",
        cta: "Запросити їх",
      },
      configure_workspace: {
      ...
      widgets: {
        ...
        description:
          "Схоже, що всі ваші віджети вимкнені. Увімкніть їх\nдля покращеного досвіду!",
        primary_button: {
  ...
  entity: {
    ...
    link_copied_to_clipboard:
      "Посилання на {entity} скопійовано до буфера обміну",
    fetch: {
  ...
  issue: {
    label:
      "{count, plural, one {Робоча одиниця} few {Робочі одиниці} other {Робочих одиниць}}",
    ...
    add: {
      ...
      cycle: {
        ...
        success:
          "{count, plural, one {Робоча одиниця} few {Робочі одиниці} other {Робочих одиниць}} додано до циклу.",
        loading:
    ...
    remove: {
      ...
      module: {
        ...
        failed:
          "Не вдалося вилучити робочу одиницю з модуля. Спробуйте ще раз.",
      },
      parent: {
    ...
    comments: {
      ...
      copy_link: {
        ...
        error:
          "Помилка при копіюванні посилання на коментар. Спробуйте пізніше.",
      },
    },
    empty_state: {
      issue_detail: {
        ...
        description:
          "Шукана робоча одиниця не існує, була заархівована або видалена.",
        primary_button: {
    ...
    archive: {
      description:
        "Архівувати можна лише завершені або скасовані\nробочі одиниці",
      label: "Заархівувати робочу одиницю",
      confirm_message:
        "Справді заархівувати цю робочу одиницю? Усі заархівовані одиниці можна пізніше відновити.",
      success: {
    ...
    restore: {
      success: {
        ...
        message:
          "Ваша робоча одиниця тепер доступна серед робочих одиниць проєкту.",
      },
      failed: {
  ...
  sub_work_item: {
    ...
    empty_state: {
      sub_list_filters: {
        title:
          "Ви не маєте похідних робочих одиниць, які відповідають застосованим фільтрам.",
        description:
          "Щоб побачити всі похідні робочі одиниці, очистіть всі застосовані фільтри.",
        action: "Очистити фільтри",
      },
      list_filters: {
        title:
          "Ви не маєте робочих одиниць, які відповідають застосованим фільтрам.",
        description:
          "Щоб побачити всі робочі одиниці, очистіть всі застосовані фільтри.",
        action: "Очистити фільтри",
      },
    },
  },
  ...
  inbox_issue: {
    status: {
      ...
      snoozed: {
        title: "Відкладено",
        description:
          "Залишилося {days, plural, one{# день} few{# дні} other{# днів}}",
      },
      accepted: {
        title: "Прийнято",
    ...
    errors: {
      snooze_permission:
        "Лише адміністратори проєкту можуть відкладати/повертати відкладені робочі одиниці",
      accept_permission:
        "Лише адміністратори проєкту можуть приймати робочі одиниці",
      decline_permission:
        "Лише адміністратори проєкту можуть відхилити робочі одиниці",
    },
    actions: {
      accept: "Прийняти",
      decline: "Відхилити",
    ...
    empty_state: {
      ...
      sidebar_filter: {
        ...
        description:
          "Немає одиниць, що відповідають фільтру у надходженнях. Створіть нову.",
      },
      detail: {
  ...
  workspace_creation: {
    ...
    subheading:
      "Щоб користуватися Plane, вам потрібно створити або приєднатися до робочого простору.",
    form: {
      name: {
  ...
  workspace_analytics: {
    ...
    pending_work_items: {
      ...
      empty_state:
        "Тут буде аналітика щодо робочих одиниць у розрізі виконавців.",
    },
    ...
    most_work_items_created: {
      ...
      empty_state:
        "Тут відображатимуться виконавці та кількість створених ними одиниць.",
    },
    most_work_items_closed: {
      title: "Найбільше закритих одиниць",
      empty_state:
        "Тут відображатимуться виконавці та кількість закритих ними одиниць.",
    },
    tabs: {
    ...
    empty_state: {
      customized_insights: {
        description:
          "Призначені вам робочі елементи, розбиті за станом, з’являться тут.",
        title: "Ще немає даних",
      },
      created_vs_resolved: {
        description:
          "Створені та вирішені з часом робочі елементи з’являться тут.",
        title: "Ще немає даних",
      },
      project_insights: {
        title: "Ще немає даних",
  ...
  workspace_projects: {
    ...
    common: {
      months_count:
        "{months, plural, one{# місяць} few{# місяці} other{# місяців}}",
    },
    empty_state: {
      general: {
      ...
      no_projects: {
        ...
        description:
          "Щоб створювати робочі одиниці, потрібно створити або приєднатися до проєкту.",
        primary_button: {
          text: "Розпочати перший проєкт",
          comic: {
            title: "Усе починається з проєкту в Plane",
      ...
      filter: {
        ...
        description:
          "Не знайдено проєктів, що відповідають критеріям.\nСтворіть новий.",
      },
      search: {
        description:
          "Не знайдено проєктів, що відповідають критеріям.\nСтворіть новий.",
  ...
  account_settings: {
    profile: {
      change_email_modal: {
        ...
        description:
          "Введіть нову адресу електронної пошти, щоб отримати посилання для підтвердження.",
        toasts: {
          success_title: "Успіх!",
        ...
        form: {
          email: {
            ...
            errors: {
              ...
              validation_failed:
                "Не вдалося підтвердити електронну пошту. Спробуйте ще раз.",
            },
          },
          code: {
            label: "Унікальний код",
            placeholder: "123456",
            helper_text:
              "Код підтвердження надіслано на вашу нову електронну пошту.",
            errors: {
    ...
    preferences: {
      heading: "Параметри",
      description:
        "Налаштуйте досвід роботи з застосунком відповідно до ваших потреб",
    },
    notifications: {
      heading: "Сповіщення електронною поштою",
      description:
        "Будьте в курсі робочих одиниць, на які ви підписані. Увімкніть сповіщення.",
    },
    security: {
      heading: "Безпека",
    },
    api_tokens: {
      ...
      description:
        "Створюйте безпечні API-токени для інтеграції з зовнішніми системами та застосунками.",
    },
    activity: {
      heading: "Активність",
      description:
        "Відстежуйте останні дії та зміни у всіх проєктах і робочих одиницях.",
    },
  },
  workspace_settings: {
    ...
    settings: {
      general: {
        ...
        delete_workspace_description:
          "Видалення простору призведе до втрати всіх даних і ресурсів. Дія незворотна.",
        ...
        errors: {
          name: {
            required: "Назва є обов’язковою",
            max_length:
              "Назва робочого простору не може перевищувати 80 символів",
          },
          company_size: {
      ...
      members: {
        ...
        leave_confirmation:
          "Справді вийти з цього простору? Ви втратите доступ. Дія незворотна.",
        details: {
      ...
      billing_and_plans: {
        ...
        description:
          "Оберіть план, керуйте підписками та легко оновлюйте їх відповідно до ваших потреб.",
      ...
      exports: {
        heading: "Експорти",
        description:
          "Експортуйте дані проєкту у різних форматах і переглядайте історію експортів.",
        title: "Експорти",
        ...
        format: "Формат",
        filters_info:
          "Застосуйте фільтри для експорту конкретних робочих одиниць за вашими критеріями.",
        modal: {
          ...
          toasts: {
            success: {
              ...
              message:
                "Ви можете завантажити експортовані {entity} у попередніх експортованих файлах.",
            },
            error: {
      ...
      webhooks: {
        heading: "Вебхуки",
        description:
          "Автоматизуйте сповіщення зовнішнім сервісам про події проєкту.",
        title: "Вебхуки",
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Застосунки, які використовують цей токен, втратять доступ. Ця дія незворотна.",
          success: {
            title: "Успіх!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Використовуйте API, щоб інтегрувати Plane із зовнішніми системами.",
      },
      webhooks: {
  ...
  project_settings: {
    general: {
      ...
      archive_project: {
        ...
        description:
          "Архівування приховає проєкт із меню. Доступ залишиться через сторінку проєктів.",
        button: "Заархівувати проєкт",
      },
      delete_project: {
        title: "Видалити проєкт",
        description:
          "Видалення проєкту призведе до знищення всіх даних. Дія незворотна.",
    ...
    states: {
      heading: "Стани",
      description:
        "Визначайте та налаштовуйте стани робочого процесу для відстеження прогресу.",
    ...
    labels: {
      heading: "Мітки",
      description:
        "Створюйте власні мітки для категоризації та організації робочих одиниць.",
    ...
    estimates: {
      ...
      description:
        "Вони допомагають повідомляти про складність і навантаження команди.",
      enable_description:
        "Допомагають комунікувати складність та навантаження команди.",
      ...
      validation: {
        ...
        unsaved_changes:
          "У вас є незбережені зміни. Збережіть їх перед тим, як натиснути «готово»",
        remove_empty:
    ...
    features: {
      cycles: {
        ...
        short_title: "Цикли",
        description:
          "Плануйте роботу в гнучких періодах, що адаптуються до унікального ритму та темпу цього проєкту.",
      ...
      modules: {
        ...
        short_title: "Модулі",
        description:
          "Організуйте роботу в підпроєкти з визначеними керівниками та виконавцями.",
        toggle_title: "Увімкнути модулі",
        toggle_description:
          "Учасники проєкту зможуть створювати та редагувати модулі.",
      },
      views: {
        title: "Подання",
        short_title: "Подання",
        ...
        toggle_description:
          "Учасники проєкту зможуть створювати та редагувати подання.",
      },
      pages: {
        title: "Сторінки",
        short_title: "Сторінки",
        description:
          "Створюйте та редагуйте вільний контент: нотатки, документи, що завгодно.",
        toggle_title: "Увімкнути сторінки",
        toggle_description:
          "Учасники проєкту зможуть створювати та редагувати сторінки.",
      },
      intake: {
        title: "Надходження",
        ...
        toggle_description:
          "Дозволити учасникам проєкту створювати запити надходження у застосунку.",
      },
    },
  },
  project_cycles: {
    ...
    remove_filters_to_see_all_cycles:
      "Приберіть фільтри, щоб побачити всі цикли",
    remove_search_criteria_to_see_all_cycles:
      "Приберіть критерії пошуку, щоб побачити всі цикли",
    only_completed_cycles_can_be_archived:
      "Архівувати можна лише завершені цикли",
    start_date: "Дата початку",
    end_date: "Дата завершення",
    ...
    action: {
      ...
      update: {
        ...
        error: {
          already_exists:
            "Цикл із цими датами вже існує. Для чернетки видаліть дати.",
        },
      },
    },
    empty_state: {
      general: {
        ...
        description:
          "Обмежуйте роботу в часі, слідкуйте за крайніми строками та рухайтеся вперед.",
        primary_button: {
          text: "Створіть перший цикл",
          comic: {
            title: "Цикли — це повторювані періоди.",
            description:
              "Спрайт, ітерація або будь-який інший період часу для відстеження роботи.",
          },
        },
      },
      no_issues: {
      ...
      completed_no_issues: {
        title: "У циклі немає робочих одиниць",
        description:
          "Одиниці переміщено або приховано. Щоб побачити їх, змініть властивості.",
      },
      active: {
        title: "Немає активного циклу",
        description:
          "Активний цикл — це цикл, що містить сьогоднішню дату. Відстежуйте його прогрес тут.",
      },
      archived: {
  ...
  project_issues: {
    empty_state: {
      no_issues: {
        ...
        description:
          "Робочі одиниці — це завдання, які ви призначаєте собі чи команді. Відстежуйте їхній прогрес.",
        primary_button: {
          text: "Створити першу одиницю",
          comic: {
            title: "Робочі одиниці — будівельні блоки",
            description:
              "Наприклад: редизайн інтерфейсу, ребрендинг, нова система.",
          },
        },
      },
      no_archived_issues: {
        ...
        description:
          "Архівуйте завершені чи скасовані одиниці. Налаштуйте автоматизацію.",
        primary_button: {
  ...
  project_module: {
    ...
    quick_actions: {
      archive_module: "Заархівувати модуль",
      archive_module_description:
        "Архівувати можна лише завершені/скасовані модулі.",
      delete_module: "Видалити модуль",
    },
    toast: {
      copy: {
  ...
  project_views: {
    empty_state: {
      general: {
        ...
        description:
          "Подання — це збережені фільтри для швидкого доступу. Діліться ними з командою.",
        primary_button: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Пишіть нотатки, документи або базу знань із допомогою AI Galileo.",
        description:
      ...
      private: {
        ...
        description:
          "Ви можете зберігати сторінки лише для себе. Поділіться, коли будете готові.",
        primary_button: {
  ...
  issue_comment: {
    empty_state: {
      general: {
        ...
        description:
          "Коментарі використовуються для обговорення та відстеження.",
      },
    },
  },
  notification: {
    ...
    empty_state: {
      ...
      all: {
        title: "Немає призначених одиниць",
        description:
          "Тут відображатимуться оновлення щодо призначених вам одиниць.",
      },
      mentions: {
        title: "Немає згадок",
  ...
  disabled_project: {
    empty_state: {
      inbox: {
        ...
        description:
          "Увімкніть надходження в налаштуваннях проєкту, щоб керувати заявками.",
        primary_button: {
  ...
  stickies: {
    ...
    empty_state: {
      ...
      general: {
        ...
        description:
          "Записуйте думки та отримуйте до них доступ з будь-якого пристрою.",
        primary_button: {
          text: "Додати нотатку",
        },
      },
      search: {
        ...
        description:
          "Спробуйте інший пошуковий запит або створіть нову нотатку.",
        primary_button: {
          text: "Додати нотатку",
        },
      },
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        copy_id_toast_success:
          "ID робочої одиниці скопійовано до буфера обміну.",
        copy_id_toast_error:
          "Під час копіювання ID робочої одиниці сталася помилка.",
        copy_title: "Копіювати назву",
        copy_title_toast_success:
          "Назву робочої одиниці скопійовано до буфера обміну.",
        copy_title_toast_error:
          "Під час копіювання назви робочої одиниці сталася помилка.",
        copy_url: "Копіювати URL",
        copy_url_toast_success:
          "URL робочої одиниці скопійовано до буфера обміну.",
        copy_url_toast_error:
          "Під час копіювання URL робочої одиниці сталася помилка.",
      },
      cycle: {
        title: "Дії з циклом",
        indicator: "Цикл",
      ...
      page: {
        ...
        copy_url_toast_error:
          "Під час копіювання URL сторінки сталася помилка.",
      },
    },
    creation_actions: {
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_success:
        "URL поточної сторінки скопійовано до буфера обміну.",
      copy_current_page_url_toast_error:
        "Під час копіювання URL поточної сторінки сталася помилка.",
  ...
  show_limited_projects_on_sidebar:
    "Показувати обмежену кількість проєктів на бічній панелі",
